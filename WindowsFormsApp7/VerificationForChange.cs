...
{
    public partial class VerificationForChange : Form
    {
        ...
        public VerificationForChange(string code, string email, string password, bool isLoginFlow = false)
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            if (userInput == sentCode)
            {
                ...
                if (insertResponse.IsSuccessStatusCode)
                {
                    ...
                    Login l = new Login(userEmail); l.Show(); this.Hide();
                }
                else
                {
